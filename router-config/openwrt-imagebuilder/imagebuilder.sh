...
rebuild_firmware() {
    ...
    my_packages="\
	base-files busybox ca-bundle dropbear e2fsprogs firewall4 fstools kmod-nft-offload  \
        ...
        btrfs-progs zram-swap block-mount coreutils-nohup tar bash curl unzip  \
